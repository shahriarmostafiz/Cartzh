...
const Drawer = ({ toggle, handleToggle, products, lang, dictionary }) => {
    return (
        ...
        <div
            id="drawer-example"
            className={`fixed top-0 left-0 z-40 h-screen p-4 overflow-y-auto transition-transform ${toggle ? "translate-x-0" : "-translate-x-full"} bg-white w-80 dark:bg-gray-800`}
            tabIndex={-1}
